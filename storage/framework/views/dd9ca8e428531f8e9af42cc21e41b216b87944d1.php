                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group<?php echo e($errors->has('birth') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="birth" type="date" class="form-control" name="birth" value="<?php echo e(old('birth')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('photo') ? ' has-error' : ''); ?>">
                            <label for="photo" class="col-md-4 control-label">Photo (optional)</label>
