...
<div class="col-md-12">
    <div class="panel panel-default panel-profile m-b-md">
        <div class="panel-body text-center">
            ...
            <img data-toggle="modal" id="ProfilePhoto" data-target="#photoModal" class="img-circle" style="cursor: pointer;width:170px" src="../storage/photo/{{$user->photo}}" />
            <br><br>
            ...
            <br />
            <span class="text-inherit" style="font-weight:bold"><a href="../user/{{$user->username}}">{{url('user/'.$user->username)}}</a></span>
        </div>
    </div>
</div>
				...
				<ul class="list-group media-list media-list-stream no-round" id="posts">
                    ...
                    <li class="media list-group-item"  style="border-top: none" >
                        <div class="media-body">
                            ...
                            <span style="white-space: pre-wrap; word-wrap: break-word; white-space: pre-line; overflow: hidden; display: block;">{{$msg->msg}}</span><br />
                            <small class="text-muted">
                                {{$msg->created_at}}&nbsp;
                            </small>
                            <form id="del-msg" action="{{ url('messages') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
